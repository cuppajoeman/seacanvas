...
## Gallery editing report

1. Open the Gallery page.
2. Click or tap **Gallery** in the navigation seven times quickly.
3. Drag paintings to reorder them. On a touch screen, use the arrow buttons.
